...
parser.add_argument('-t', '--tool', metavar='TOOL', dest='tool', choices=['lldb', 'gdb', 'memcheck', 'perf'], help='Wrap opp_run execution in TOOL (lldb, gdb or memcheck)')
